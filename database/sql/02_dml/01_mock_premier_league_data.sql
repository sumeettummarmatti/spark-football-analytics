...
-- Clear existing data
TRUNCATE TABLE MATCH_PREDICTIONS RESTART IDENTITY CASCADE;
TRUNCATE TABLE MATCH_EVENT RESTART IDENTITY CASCADE;
TRUNCATE TABLE MATCH_LINEUPS RESTART IDENTITY CASCADE;
TRUNCATE TABLE MATCHES RESTART IDENTITY CASCADE;
TRUNCATE TABLE TEAM_SEASONS RESTART IDENTITY CASCADE;
TRUNCATE TABLE PLAYER_NICKNAMES RESTART IDENTITY CASCADE;
